...
def create_face_selector_program() -> ArgumentParser:
	...
	group_face_selector.add_argument('--face-mappings-file', help = wording.get('help.face_mappings_file'), default = config.get_str_value('face_selector', 'face_mappings_file'))
	job_store.register_step_keys([ 'face_selector_mode', 'face_selector_order', 'face_selector_gender', 'face_selector_race', 'face_selector_age_start', 'face_selector_age_end', 'reference_face_position', 'reference_face_distance', 'reference_frame_number', 'face_mappings_file' ])
	return program
