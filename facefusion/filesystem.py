...
def create_temp(target_path : str) -> None:
	...
	# logger.info(f"-----> create_temp temp_directory_path: {temp_directory_path}")
...
def clear_temp(target_path : str) -> None:
	...
	# logger.info(f"-----> clear_temp temp_directory_path: {temp_directory_path}")

	if not facefusion.globals.keep_temp and is_directory(temp_directory_path):
		# logger.info(f"-----> clear_temp remove temp_directory_path: {temp_directory_path}")
		shutil.rmtree(temp_directory_path, ignore_errors = True)
	if os.path.exists(parent_directory_path) and not os.listdir(parent_directory_path):
		# logger.info(f"-----> clear_temp remove parent_directory_path: {parent_directory_path}")
